// this one makes Omicron's disabled minion(s) make constant pings, even if out of sight
...
public class OmicronMinionPlugin extends BaseCustomEntityPlugin {
		...
		if (entity.isInCurrentLocation()) {
			...
			if (sincePing >= 6f && phase > 0.1f && phase < 0.2f) {
				...
				if (playerFleet != null) {
					...
					String pingId = AEIDs.OMICRON_MINION_PING;
					freqMult = 0.05f;
